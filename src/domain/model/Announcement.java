...
public class Announcement {
	...
	public Date getPrivateAnnounceDate() {
		return privateAnnounceDate;
	}

	public void setPrivateAnnounceDate(Date privateAnnounceDate) {
		this.privateAnnounceDate = privateAnnounceDate;
	}

	public Date getPublicAnnounceDate() {
		return publicAnnounceDate;
	}

	public void setPublicAnnounceDate(Date publicAnnounceDate) {
		this.publicAnnounceDate = publicAnnounceDate;
	}
	...
	public String toString() {
		if (publicAnnounceDate.beforeCurrentDate() == true) {
			return String.format(
					getPublicAnnounceDate().toString() + "        Public Announcement: " + getAnnounceMessage());

		} else if (privateAnnounceDate.beforeCurrentDate() == true) {
			return String.format(
					getPrivateAnnounceDate().toString() + "        Private Announcement: " + getAnnounceMessage());
		}
